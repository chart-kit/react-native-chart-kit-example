...
import { analyticsBlue, analyticsChartTheme } from "./constants";
import { analyticsTrend, createRealtimeCountryRows } from "./data";
import {
  formatCompactUsers,
...
export const WebsiteAnalyticsScreen = ({
  ...
  const [selectedTrendIndex, setSelectedTrendIndex] = useState<
    number | undefined
  >();
  const { rows: realtimeRows, tick: realtimeTick } =
      ...
      <View style={styles.panel}>
        <View style={styles.panelHeader}>
          ...
          <Text style={styles.panelMeta}>
            {formatWholeNumber(realtimeTotal)}
          </Text>
        </View>
        <View style={styles.chartSlot}>
          <Realtime.BarChart
